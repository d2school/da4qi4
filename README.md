...
## 0.5 服务生产，不服务自嗨
作者自嗨的话，应该什么都用最新最酷最炫……但要用于生产，除了简单，还要稳定、便捷。所以d只要有你一台Ubuntu 18.04 的服务器（国内云服务器提供商都可提供），就可以简单几行指令准备好da4qi4的开发及部轨环境。（学生或24岁以下的年轻人的话，推荐云腾讯云按一月10元的钱买台1核2G1M的服务器……[腾讯云+校园](https://cloud.tencent.com/act/campus?from=11419)……）

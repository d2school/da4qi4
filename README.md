- [零、几个原则](#------)
  ...
  * [0.3 易用优于性能](#03-------)
- [一、快速了解](#------)
  * [1.1 一个空转的Web Server](#11------web-server)
  * [1.2 Hello World!](#12-hello-world-)
    + [1.2.1 针对指定URL的响应](#121-----url---)
    + [1.2.2 返回HTML](#122---html)
  * [1.3 处理请求](#13-----)
  * [1.4 引入“Application”](#14----application-)
  * [1.5 运行日志](#15-----)
  * [1.6 HTML 模板](#16-html---)
  * [1.7 更多](#17---)
- [二、如何构建](#------)
  ...
  * [2.4 下载大器源代码](#24--------)
  * [2.5  编译“大器”库](#25---------)
  * [2.6 在你的项目中使用 da4qi4库](#26----------da4qi4-)
- [三、运行时外部配套系统](#-----------)
  * [3.1 运行时依赖说明](#31--------)
  * [3.2 Redis的安装](#32-redis---)
  * [3.3 数据库](#33----)
